...
This repository contains the Patient Registration OpenMRS Open Web App.
...
This will create a file called `patientregistration.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/larry/openmrs/openmrs/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/larry/openmrs/openmrs/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/larry/openmrs/openmrs/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/patientregistration/index.html"
}
```
